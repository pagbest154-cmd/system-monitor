export const i18n = {
  ...
  hosts: {
    ...
    version: "Версия",
    versionUnknownHint: "Обновите агент — версия появится после следующей отправки метрик",
    update: "Обновить",
    updateTitle: "Как обновить агент",
    updateModalTitle: "Обновление агента",
    updateLatest: "Доступна версия",
    updateCurrent: "Установлена",
    updateLinuxApt: "Через APT (рекомендуется)",
    updateLinuxDeb: "Скачать .deb",
    updateWindows: "Скачать установщик Windows",
    updateWindowsTray: "Или обновите через иконку SysMon agent в трее.",
    updateRelease: "Все релизы на GitHub",
    ...
    delete: "Удалить",
    deleteConfirm: "Удалить хост «{name}»? История метрик будет удалена безвозвратно.",
    deleteFailed: "Не удалось удалить хост",
    alertsTitle: "Push-уведомления",
    alertsClose: "Закрыть",
    alertsEnabled: "Уведомления для хоста",
    alertsOffline: "Хост недоступен",
    alertsOfflineSec: "Секунд без связи",
    alertsCooldown: "Пауза между повторами",
    alertsSensors: "Датчики — порог срабатывания",
    alertsSensorName: "Датчик",
    alertsThreshold: "Порог ≥",
    alertsNtfyTitle: "ntfy — подписка на уведомления",
    alertsNtfyServer: "Сервер ntfy",
    alertsNtfyTopic: "Topic (секрет подписки)",
    alertsNtfyCopy: "Копировать topic",
    alertsNtfyCopied: "Скопировано",
    alertsNtfyRegenerate: "Новый topic",
    alertsNtfyHint: "В приложении SysMon включите подписку на этот topic или используйте приложение ntfy.",
    alertsHint: "Хаб отправляет уведомления через ntfy. Topic — как пароль: не публикуйте его.",
    alertsCancel: "Отмена",
