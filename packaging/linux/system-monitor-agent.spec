...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "system_monitor.collector.registry",
        "system_monitor.collector.system",
        "system_monitor.collector.temperature",
        "system_monitor.collector.gpio",
        "system_monitor.collector.remote",
        ...
        "system_monitor.release_updates",
        "system_monitor.storage",
        "system_monitor.storage.sqlite_store",
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=["fastapi", "uvicorn", "grpc", "pystray", "PIL", "tkinter", "wmi"],
